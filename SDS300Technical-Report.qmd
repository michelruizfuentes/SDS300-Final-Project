...
Null Hypothesis states there is no difference in the mean score of participant's choice of gamble (A or B) depending on whether they receive feedback or information about the outcomes of the variables. The true difference between the group means would be zero to indicate the means are the same and do not change based on the treatment provided; treatment being the feedback or information levels.

Alternative Hypothesis states there is at least one difference mean score of participant's choice of gamble (A or B) depending on whether they receive feedback or information about the outcomes of the variables. The true difference between the group means is different from zero. The true difference between the group means would contrast and therefore not include zero to indicate the means are vary based on the treatment provided; treatment being the feedback or information levels.

Based on the literature, I support the alternative hypothesis and believe there will be a difference in the mean score of participant's choice of gamble (A or B) depending on the treatment and level provided: whether they receive feedback (true or false) or information (none or complete). Kahneman and Tversky's research on decision-making and risk perception indicates that the feedback and perception used to frame risky-choice problems influence the participant's choice. For example, if one gamble was framed positively for having a gain outcome, the subject preferred a risk-averse option. On the other hand, if another gamble was framed negatively for having a potential loss, the subject preferred a risk-seeking option.
...
Based on the data set provided and the revision required for the research question, and hypothesis, the first revisions that I would recommend for this data set and how an investigator could continue this work, would start with computing the frequency with which participants selected Gamble A to compare against `bRate` during the experiment. With this revision, I would have been able to test my original research question about how receiving various levels of feedback or information impacted the frequency rate of choosing Gamble A (risk-averse) and Gamble B (risk-seeking option); however in this test I was only able to test the risk-seeking option of `bRate`.

Second, the researchers of the Choices13k data set could talk more about whether there was random sampling to show if we can draw population inferences or develop generalizable insights. Additionally, they could specify if they randomly assigned the treatment because although they stated that the following data was conducted via an experimental design, clarifying if there was random assignment for the treatments could further confirm that this was an experiment.

pre-registration

How could someone continue the work? Around 150-200 words.\] fMRI can show which brain regions and neural activity specifically visualized dopamine reward pathways <https://www.pnas.org/doi/10.1073/pnas.0606297104> 

What machine learning will mean for asset managers and the future of investing. <https://hbr.org/2019/12/what-machine-learning-will-mean-for-asset-managers> 

# Personal Reflections

\[What was your original research question? Why did you have to deviate? What ideal data set would be recommended for collecting? How was this process of developing a research paper? 250 words\].

**WHY FINANCIAL RISK: risk and ambiguity, volatility, Statistics, and Probability; Decision theory, general equilibrium theory**
